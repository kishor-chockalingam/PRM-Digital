...
import com.hybris.mobile.fragment.AddressFragment;
import com.hybris.mobile.fragment.AddressFragment.DoneClickListener;
import com.hybris.mobile.fragment.FormPopupSelectFragment;
...
/** Note: for fragments, {@link FormPopupSelectFragment} was created. */
public class FormPopupSelectActivity extends HybrisListActivity implements SubmitListener
{
	private static final String LOG_TAG = FormPopupSelectActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState, String plistFile)
	{
		...
		mAdapter = new FormAdapter(this, entries, new FormAdapter.FocusChangeListner()
		{
			...
			{
				FormPopupSelectActivity.this.fieldsValidated();
			}
		});
	...
	{
		if (requestCode == InternalConstants.PICKER_RESULT_CODE && resultCode == RESULT_OK)
		{
	...
	public FormAdapter getmAdapter()
	{
		return mAdapter;
	}

	public void setmAdapter(FormAdapter mAdapter)
	{
